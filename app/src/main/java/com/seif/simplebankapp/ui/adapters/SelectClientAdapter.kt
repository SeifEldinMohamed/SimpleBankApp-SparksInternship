...
class SelectClientAdapter(val context: Context) :
    RecyclerView.Adapter<SelectClientAdapter.MyViewHolder>() {
        ...
        fun bind(position: Int, clients: List<Clients>) {
            ...
            binding.itemRowClient.setOnClickListener {
                ...
                itemView.findNavController()
                    .navigate(R.id.action_selectClientFragment_to_clientsFragment)
                Toast.makeText(context, "Transaction in done successfully!", Toast.LENGTH_SHORT)
                    .show()
            }
        }
    }
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        clientViewModel =
            ViewModelProvider(context as FragmentActivity)[ClientsViewModel::class.java]
        transactionViewModel =
            ViewModelProvider(context as FragmentActivity)[TransactionViewModel::class.java]
